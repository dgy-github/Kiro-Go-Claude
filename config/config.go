...
type Config struct {
	...
	// ClaudeNativeCompact lets Kiro-Go trigger Claude Code's own /compact command
	// when incoming Claude Desktop/Code requests become too large. It is off by
	// default because it appends to local Claude transcripts.
	ClaudeNativeCompactEnabled         bool   `json:"claudeNativeCompactEnabled,omitempty"`
	ClaudeNativeCompactBodyThresholdKB int    `json:"claudeNativeCompactBodyThresholdKB,omitempty"`
	ClaudeNativeCompactTokenThreshold  int    `json:"claudeNativeCompactTokenThreshold,omitempty"`
	ClaudeNativeCompactCooldownSeconds int    `json:"claudeNativeCompactCooldownSeconds,omitempty"`
	ClaudeNativeCompactMaxOutputTokens int    `json:"claudeNativeCompactMaxOutputTokens,omitempty"`
	ClaudeNativeCompactProjectsRoot    string `json:"claudeNativeCompactProjectsRoot,omitempty"`
	ClaudeNativeCompactProjectDir      string `json:"claudeNativeCompactProjectDir,omitempty"`
	ClaudeNativeCompactSessionID       string `json:"claudeNativeCompactSessionId,omitempty"`
...
type ClaudeNativeCompactConfig struct {
	Enabled         bool
	BodyThresholdKB int
	TokenThreshold  int
	CooldownSeconds int
...
// GetClaudeNativeCompactConfig returns settings for the optional local Claude
// Code /compact integration. Environment variables override config.json:
// KIRO_GO_CLAUDE_NATIVE_COMPACT_ENABLED, _BODY_THRESHOLD_KB, _TOKEN_THRESHOLD,
// _COOLDOWN_SECONDS, _MAX_OUTPUT_TOKENS, _PROJECTS_ROOT, _PROJECT_DIR, _SESSION_ID.
func GetClaudeNativeCompactConfig() ClaudeNativeCompactConfig {
	cfgLock.RLock()
	defer cfgLock.RUnlock()

	out := ClaudeNativeCompactConfig{
		Enabled:         false,
		BodyThresholdKB: 1536,
		TokenThreshold:  250000,
		CooldownSeconds: 600,
		MaxOutputTokens: 64000,
	}
	if cfg != nil {
		out.Enabled = cfg.ClaudeNativeCompactEnabled
		if cfg.ClaudeNativeCompactBodyThresholdKB > 0 {
			out.BodyThresholdKB = cfg.ClaudeNativeCompactBodyThresholdKB
		}
		if cfg.ClaudeNativeCompactTokenThreshold > 0 {
			out.TokenThreshold = cfg.ClaudeNativeCompactTokenThreshold
		}
		if cfg.ClaudeNativeCompactCooldownSeconds > 0 {
			out.CooldownSeconds = cfg.ClaudeNativeCompactCooldownSeconds
		}
		if cfg.ClaudeNativeCompactMaxOutputTokens > 0 {
			out.MaxOutputTokens = cfg.ClaudeNativeCompactMaxOutputTokens
		}
		out.ProjectsRoot = cfg.ClaudeNativeCompactProjectsRoot
		out.ProjectDir = cfg.ClaudeNativeCompactProjectDir
		out.SessionID = cfg.ClaudeNativeCompactSessionID
	}

	out.Enabled = envBool("KIRO_GO_CLAUDE_NATIVE_COMPACT_ENABLED", out.Enabled)
	out.BodyThresholdKB = envInt("KIRO_GO_CLAUDE_NATIVE_COMPACT_BODY_THRESHOLD_KB", out.BodyThresholdKB)
	out.TokenThreshold = envInt("KIRO_GO_CLAUDE_NATIVE_COMPACT_TOKEN_THRESHOLD", out.TokenThreshold)
	out.CooldownSeconds = envInt("KIRO_GO_CLAUDE_NATIVE_COMPACT_COOLDOWN_SECONDS", out.CooldownSeconds)
	out.MaxOutputTokens = envInt("KIRO_GO_CLAUDE_NATIVE_COMPACT_MAX_OUTPUT_TOKENS", out.MaxOutputTokens)
	out.ProjectsRoot = envString("KIRO_GO_CLAUDE_NATIVE_COMPACT_PROJECTS_ROOT", out.ProjectsRoot)
	out.ProjectDir = envString("KIRO_GO_CLAUDE_NATIVE_COMPACT_PROJECT_DIR", out.ProjectDir)
	out.SessionID = envString("KIRO_GO_CLAUDE_NATIVE_COMPACT_SESSION_ID", out.SessionID)
	return out
}
